...
gulp.task('externcss', function () {
    return gulp.src(build.input.files.extern_css)
        .pipe(gulp.dest(build.output.dirs.styles));
});

gulp.task('externjs', function () {
...
gulp.task('copy', ['public', 'scripts', 'styles', 'externjs', 'externcss'/* , 'polyfills' */], function () { });
